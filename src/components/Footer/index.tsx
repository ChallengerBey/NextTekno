        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                href="#"
                aria-label="Facebook Sosyal Bağlantı"
                className="flex ease-out duration-200 hover:text-orange-500"
              >
                <svg
              ...
              <a
                href="#"
                aria-label="Twitter Sosyal Bağlantı"
                className="flex ease-out duration-200 hover:text-orange-500"
              >
                <svg
                  className="fill-current"
              ...
              <a
                href="#"
                aria-label="Instagram Sosyal Bağlantı"
                className="flex ease-out duration-200 hover:text-orange-500"
              >
                <svg
                  className="fill-current"
              ...
              <a
                href="#"
                aria-label="LinkedIn Sosyal Bağlantı"
                className="flex ease-out duration-200 hover:text-orange-500"
              >
                <svg
                  className="fill-current"
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a className="ease-out duration-200 hover:text-orange-500" href="#">
                  Hesabım
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              ...
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-orange-500 ease-out duration-200 hover:bg-opacity-95"
                  href="#"
                >
                  <svg
                    className="fill-current"
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <p className="font-medium">Kabul Edilenler:</p>

              <div className="flex flex-wrap items-center gap-6">
                <a href="#" aria-label="visa kart ile ödeme sistemi">
                  <Image
                ...
                <a href="#" aria-label="paypal ile ödeme sistemi">
                  <Image
                ...
                <a href="#" aria-label="master card ile ödeme sistemi">
                  <Image
                ...
                <a href="#" aria-label="apple pay ile ödeme sistemi">
                  <Image
                ...
                <a href="#" aria-label="google pay ile ödeme sistemi">
                  <Image
