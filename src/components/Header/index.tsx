  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className="flex flex-col lg:flex-row gap-5 items-end lg:items-center xl:justify-between ease-out duration-200 py-2"
        >
          {/* <!-- header top left --> */}
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0 h-16 w-[280px] overflow-visible" href="/">
              <Image
                src="/images/logo/logo.svg"
                alt="Logo"
                width={150}
                height={32}
                className="h-16 w-auto scale-[2.6] origin-left"
              />
            </Link>
      ...
      <div className="border-t border-gray-3 py-0">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      >
                        <Link
                          href={menuItem.path}
                          className={`hover:text-blue text-custom-sm font-medium text-dark flex ${stickyMenu ? "xl:py-0.5" : "xl:py-1"
                            }`}
                        >
                          {menuItem.title}
                        </Link>
